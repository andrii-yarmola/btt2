    ...
    return (
      <form className="orders-form" >
          ...
          <div className="table-filters">
            <div className="show-categories">
              ...
              <ul className="categories-list">
                <li className="active"><a href="#">Everything</a></li>
                <li><a href="#">Generated</a></li>
                <li><a href="#">Paid</a></li>
              </ul>
            </div>
            <div className="show-period">
              <span>from</span>
              <div className="date-holder">
                <input type="text" className="form-control form-control-picker date-picker" placeholder="Date" data-required="true" readOnly/>
              ...
              <a href="#" className="btn btn-primary">Reset period</a>
            </div>
          </div>
        </div>
        <div className="table-holder table-responsive">
          ...
          {(!this.state.tableData.length) && <div className='noFound'> No orders found ... </div>}
        </div>
...
ClientsTable.propTypes = {
  getOrders: React.PropTypes.func.isRequired
}
